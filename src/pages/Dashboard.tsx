    ...
    <div className="p-6 space-y-4">
      {role === 'employer' ? (
        <>
          ...
          <Link to="/dashboard" className="w-full border border-gray-300 text-gray-700 px-4 py-3 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center">
